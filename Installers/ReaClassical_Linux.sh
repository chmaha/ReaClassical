...
res_url="https://github.com/chmaha/ReaClassical/raw/ltsc/Resource%20Folder/Resource_Folder_Base.zip"
curl -L -o "$res_output" --progress-bar "$res_url"
up_output="$temp_dir/UP_Linux-${arch}.zip"
up_url="https://github.com/chmaha/ReaClassical/raw/ltsc/Resource%20Folder/UserPlugins/UP_Linux-${arch}.zip"
