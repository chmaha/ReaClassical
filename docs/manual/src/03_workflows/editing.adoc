...
NOTE: In ReaClassical 26 this is handled on behalf of the user as much as possible including when opening Mission Control, placing your first source-destination marker and opening kbd:[F5] Preferences. 

Whether working horizontally or vertically, you can use the Prepare Takes function. It is intelligent enough to figure out which workflow you are using. Just press kbd:[T] (for _Takes_). Super simple! Every item comprising the same take are now grouped together.
