...
-- Raise the selected item group's volume by 1 dB (selection-aware).
--   Left selected  → raise item1 group volume by 1 dB.
--   Right selected → raise item2 group volume by 1 dB.
...
local function main()
    ...
    UpdateTimeline()
    PreventUIRefresh(-1)
    Undo_EndBlock("XFM Item Volume Up 1dB", -1)
