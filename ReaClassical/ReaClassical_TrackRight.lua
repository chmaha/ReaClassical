...
-- mappings globally deduplicated (first group wins), then moves each item
-- exactly once. Prevents child items at boundaries from being moved twice.
