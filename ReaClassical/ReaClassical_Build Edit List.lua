...
<body>
    ...
    <span class="description">Absolute location on the timeline for building the edit</span><br>
    ...
    for i = 0, item_count - 1 do
        ...
        if i + 1 < item_count then
            ...
            if next_position > position + length then
                local gap_duration = next_position - (position + length)
                table.insert(item_table, {
                    edit_number = "Gap",
                    position = format_timecode(position, fps),
                    filename = "",
