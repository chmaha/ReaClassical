...
-- Lower the selected item group's volume by 1 dB (selection-aware).
--   Left selected  → lower item1 group volume by 1 dB.
--   Right selected → lower item2 group volume by 1 dB.
...
local STEP_LIN = 10 ^ (1.0 / 20)  -- 1 dB as a linear multiplier
...
local function main()
    ...
    UpdateTimeline()
    PreventUIRefresh(-1)
    Undo_EndBlock("XFM Item Volume Down 1dB", -1)
