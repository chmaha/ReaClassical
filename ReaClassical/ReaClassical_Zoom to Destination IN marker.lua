...
local main, markers, exclusive_select_folder_parent, zoom, solo
...
function main()
    ...
    if marker_count == 0 then
        say("No destination in marker found")
        return
    end
    ...
    say("Zoomed to destination in @ " .. humanize_timestr(format_timestr_pos(GetCursorPosition(), "", -1))
