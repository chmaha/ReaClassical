...
@changelog
  ...
  NEW: Accessible Automation Navigator
  NEW: Toggle Special Tracks
  NEW: XFM (Accessible Fade Editor)
  NEW: Toggle record monitoring off and on
  NEW: Headless Record Panel daemon
  NEW: Headless Mixer Snapshots daemon
  ...
  New splash screen
  Switch to Clara to manually output messages to screenreader
@metapackage
@provides
  [jsfx] *.jsfx
  [rpp] *.RPP
