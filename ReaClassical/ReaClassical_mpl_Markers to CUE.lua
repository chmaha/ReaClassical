...
function create_html_report(albumTitle, albumPerformer, tracks, htmlOutputPath, albumLength, catalog_number)
    ...
    file:write("<link rel='stylesheet' href='https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css'>\n")
    file:write("<style>\n")
    ...
    for _, track in ipairs(tracks or {}) do
        ...
        file:write("        <td>" .. string.format("%02d:%02d:%02d", track.mm or 0, track.ss or 0, track.ff or 0) .. "</td>\n")
