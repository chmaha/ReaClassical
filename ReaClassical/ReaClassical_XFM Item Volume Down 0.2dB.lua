...
-- Lower the selected item group's volume by 0.2 dB (selection-aware).
--   Left selected  → lower item1 group volume by 0.2 dB.
--   Right selected → lower item2 group volume by 0.2 dB.
...
local function main()
    ...
    UpdateTimeline()
    PreventUIRefresh(-1)
    Undo_EndBlock("XFM Item Volume Down 0.2dB", -1)
