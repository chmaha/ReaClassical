...
local main, is_special_track, get_folder_parent, get_folder_tracks, say
...
function main()
    ...
    local _, name = GetSetMediaTrackInfo_String(prev_track.track, "P_NAME", "", false)
    say("Track: " .. name)
end
